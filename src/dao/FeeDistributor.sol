...
contract FeeDistributor is AltheaOwnable, SystemStart, DelegatedOps {
...
constructor(address _altheaCore, ITokenLocker _tokenLocker) PrismaOwnable(_altheaCore) SystemStart(_altheaCore) {
